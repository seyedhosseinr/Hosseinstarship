...
/* Ink palette â€” GoodNotes-style calm study colors */
...
export const DrawingLayer = forwardRef<DrawingLayerHandle, DrawingLayerProps>(
  function DrawingLayer(
    ...
    const redraw = useCallback(() => {
      ...
      // Live circle preview while dragging in circle mode
    ...
    const persist = useCallback(() => {
      ...
      try {
        ...
        // quota exceeded â€” skip silently
      }
    }, [contentSelector]);
    ...
    const finishStroke = useCallback(
      (e: PointerEvent) => {
        ...
        // Commit circle shape as ellipse arc points
