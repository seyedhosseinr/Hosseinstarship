/* @ts-self-types="./edge_parser.d.ts" */

/**
 * Free the parser state. MUST be called exactly once per `init_parser()`.
 * @param {number} state_ptr
 */
export function destroy_parser(state_ptr) {
    wasm.destroy_parser(state_ptr);
}
 ...
 * @returns {string}
 */
export function flush_parser(state_ptr) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.flush_parser(retptr, state_ptr);
 ...
 * @returns {string}
 */
export function get_parse_errors(state_ptr) {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_parse_errors(retptr, state_ptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
 ...
 * @returns {string}
 */
export function get_progress(state_ptr) {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_progress(retptr, state_ptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        deferred1_0 = r0;
        deferred1_1 = r1;
 ...
 * @returns {string}
 */
export function parse_chunk(state_ptr, chunk) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.parse_chunk(retptr, state_ptr, addHeapObject(chunk));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('edge_parser_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
